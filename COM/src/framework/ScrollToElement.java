...
public class ScrollToElement {
	public static void scrollToElement(String viewPort, String functionality, String driverExecute, String testCaseno,
			...
			Set<String> windowhandles, ExtentTest test) {
		try {
